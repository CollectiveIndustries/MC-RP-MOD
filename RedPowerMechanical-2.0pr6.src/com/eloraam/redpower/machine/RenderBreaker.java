...
/* 28:   */   {
/* 29:28 */     TileBreaker tb = (TileBreaker)CoreLib.getTileEntity(iba, i, j, k, TileBreaker.class);
/* 30:30 */     if (tb == null) {
/* 31:30 */       return;
/* 32:   */     }
...
/* 35:   */     
/* 36:35 */     int act = tb.Active ? 1 : 0;
/* 37:36 */     this.context.setPos(i, j, k);
/* 38:37 */     this.context.readGlobalLights(iba, i, j, k);
/* 39:38 */     this.context.setTex(58, 49 + act, 51 + act, 51 + act, 51 + act, 51 + act);
/* 40:   */     
...
/* 61:59 */     tessellator.b();
/* 62:   */     
/* 63:61 */     this.context.setTex(58, 49, 51, 51, 51, 51);
 ...
 * Qualified Name:     com.eloraam.redpower.machine.RenderBreaker
